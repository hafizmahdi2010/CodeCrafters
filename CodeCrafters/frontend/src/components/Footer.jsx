  ...
  return (
    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="#" className="flex items-center">
                  ...
                  <span className="self-center text-2xl font-semibold whitespace-nowrap">CodeCrafters✅</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li className="mb-4">
                          <a href="https://tailwindcss.com/" className="hover:underline">Templates</a>
                      </li>
                      <li className="mb-4">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">CodeCrafters</a>. All Rights Reserved.
          </span>
