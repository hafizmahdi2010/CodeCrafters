...
const Testamonials = () => {
  return (
    <>
      <section className="testamonials text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <h1 className="text-4xl sm:ml-0 mb-12 text-center text-black">Testimonials</h1>
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/2 w-full">
        <div className="testamonial h-full bg-gray-100 p-8 rounded">
          ...
          <a className="inline-flex items-center">
            ...
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium text-slate-500">Holden Caulfield</span>
      ...
      <div className="p-4 md:w-1/2 w-full">
        <div className="testamonial h-full bg-gray-100 p-8 rounded">
          ...
          <a className="inline-flex items-center">
            ...
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium text-slate-500">Alper Kamu</span>
